...
prod_test_stats()
{
    ...
    $bt_test_bin --bt-port $uart_port --bt-bs-baud $new_baudrate --config-path /data --test stats
}
...
prod_test_tx_burst()
{
    ...
    $bt_test_bin --bt-port $uart_port --bt-bs-baud $new_baudrate --config-path /data --test tx_burst
}
...
prod_test_tx_continous()
{
    ...
    $bt_test_bin --bt-port $uart_port --bt-bs-baud $new_baudrate --config-path /data --test tx_continous
}
...
prod_test_rx_burst()
{
    ...
    $bt_test_bin --bt-port $uart_port --bt-bs-baud $new_baudrate --config-path /data --test rx_burst
}
...
prod_test_rx_burst_config()
{
    ...
    $bt_test_bin --bt-port $uart_port --bt-bs-baud $new_baudrate --config-path /data --test rx_burst_config
}
