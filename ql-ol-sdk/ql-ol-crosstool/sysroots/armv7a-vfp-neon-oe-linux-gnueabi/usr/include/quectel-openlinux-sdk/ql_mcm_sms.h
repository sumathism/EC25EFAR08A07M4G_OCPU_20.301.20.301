...
/*set recvice sms format
*/
void quectel_set_recvsms_format(int e_format);

/* Get sms routes list.
*/
int QL_SMS_Get_Routes_List(sms_client_handle_type  h_sms,
                        ql_sms_route_info_list_t   *pt_route_list);

/* Read stored SMS content.
*/
int QL_SMS_Read_Msg(sms_client_handle_type  h_sms,
                ql_sms_storage_info_t  *pt_sms_storage,
                ql_sms_info_t *pt_sms_info);
/*
