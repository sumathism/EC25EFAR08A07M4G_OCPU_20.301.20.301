...
/*============================================================================
  ...
  10/11/2018       Mike        Add quectel_hexdump_string_check to checking hex string
============================================================================*/
...
/**
 * The function checking hexdump string.
 *
 * @param[in] hexdump         hexdump string
 *
 * @return On success, Zero is returned. On error, -1 is returned.
 * 
 */
extern int quectel_hexdump_string_check(const char *hexdump);


extern int quectel_str_to_hex(char * str, unsigned char * hex);

/**
 * The function checking mac string.
 *
 * @param[in] hexdump         hexdump string
 *
 * @return On success, Zero is returned. On error, -1 is returned.
 * 
 */
extern int quectel_mac_string_check(char *mac_string);
