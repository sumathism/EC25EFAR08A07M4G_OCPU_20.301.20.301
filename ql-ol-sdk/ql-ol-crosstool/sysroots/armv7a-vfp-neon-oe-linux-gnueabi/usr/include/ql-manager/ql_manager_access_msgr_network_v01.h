...
}ql_manager_msgr_set_ippt_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  result_v01 res;
}ql_manager_msgr_set_ippt_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}ql_manager_msgr_get_ippt_config_req_msg_v01;
...
typedef struct {
  ...
  /* Mandatory */
  char client_device_name[64];
}ql_manager_msgr_get_ippt_config_resp_msg_v01;  /* Message */
/**
    @}
  */
