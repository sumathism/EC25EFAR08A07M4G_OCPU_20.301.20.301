...
/*============================================================================
  ...
  11/13/2018       Mike        Adds usb function.
  12/28/2018       Mike        Adds WiFi station scan event.
============================================================================*/
...
#ifdef FEATURE_QL_USB
#include "ql_mgmt_usb.h"
#endif /* end of FEATURE_QL_USB */

#ifdef FEATURE_QL_BT
#include "ql_mgmt_bt.h"
#endif /* end of FEATURE_QL_BT */
...
#define QL_MGMT_CLIENT_COMMAND_USB         0x0007
#define QL_MGMT_CLIENT_COMMAND_BT          0x0008
...
typedef enum {
	...
	QL_COMMAND_WIFI_STATION_SCAN = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_WIFI, QL_MGMT_CLIENT_COMMAND_WIFI_STA_SCAN),
	QL_COMMAND_WIFI_STATION_SCAN_RESULT = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_WIFI, QL_MGMT_CLIENT_COMMAND_WIFI_STA_SCAN_RESULT),
	QL_COMMAND_WIFI_ACCESS_PROFILE = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_WIFI, QL_MGMT_CLIENT_COMMAND_WIFI_ACCESS_PROFILE),
#endif /* end of FEATURE_QL_WIFI */
	...
	QL_COMMAND_NETWORK_IPPT_CONFG_SET = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_NETWORK, QL_MGMT_CLIENT_COMMAND_NETWORK_IPPT_CONFIG_SET),
	QL_COMMAND_NETWORK_IPPT_CONFG_GET = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_NETWORK, QL_MGMT_CLIENT_COMMAND_NETWORK_IPPT_CONFIG_GET),
#endif /* end of FEATURE_QL_NETWORK */

#ifdef FEATURE_QL_USB
	QL_COMMAND_USB_CONFIG_WRITE = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_CONFIG_WRITE),
	QL_COMMAND_USB_ACTION = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_ACTION),
	QL_COMMAND_USB_BOOTUP = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_BOOTUP),
	QL_COMMAND_USB_ID = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_ID),
	QL_COMMAND_USB_PRODUCT_INFO = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_PRODUCT_INFO),
	QL_COMMAND_USB_MANUFAC_INFO = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_MANUFAC_INFO),
	QL_COMMAND_USB_NET = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_NET),
	QL_COMMAND_USB_FUNC = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_FUNC),
	QL_COMMAND_USB_CONFIG = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_CONFIG),
	QL_COMMAND_USB_INTERFACE_WRITE = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_INTERFACE_WRITE),
	QL_COMMAND_USB_INTERFACE = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_USB, QL_MGMT_CLIENT_COMMAND_USB_INTERFACE),
#endif /* end of FEATURE_QL_USB */

#ifdef FEATURE_QL_BT
	QL_COMMAND_BT_MAC = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_BT, QL_MGMT_CLIENT_COMMAND_BT_MAC),
#endif /* end of FEATURE_QL_BT */
...
typedef enum {
	...
	QL_COMMAND_IND_WIFI_STA_SCAN = COMMAND_OFFSET(QL_MGMT_CLIENT_COMMAND_WIFI, QL_MGMT_CLIENT_COMMAND_WIFI_STA_SCAN),
#endif /* end of FEATURE_QL_WIFI */
