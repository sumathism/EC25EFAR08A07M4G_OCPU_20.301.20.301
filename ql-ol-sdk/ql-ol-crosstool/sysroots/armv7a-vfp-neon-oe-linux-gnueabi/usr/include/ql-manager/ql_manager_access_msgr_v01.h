...
#include "ql_manager_access_msgr_usb_v01.h"
#include "ql_manager_access_msgr_bt_v01.h"
...
#define QL_MANAGER_MSGR_V01_MAX_MESSAGE_ID 0x0054
/**
    @}
  */
...
#define QL_MANAGER_MSGR_SET_WIFI_STA_SCAN_REQ_V01 0x0028
#define QL_MANAGER_MSGR_SET_WIFI_STA_SCAN_RESP_V01 0x0028
#define QL_MANAGER_MSGR_SET_WIFI_STA_SCAN_DOEN_IND_V01 0x0028
#define QL_MANAGER_MSGR_SET_WIFI_STA_SCAN_RESULT_REQ_V01 0x0029
#define QL_MANAGER_MSGR_SET_WIFI_STA_SCAN_RESULT_RESP_V01 0x0029
#define QL_MANAGER_MSGR_SET_WIFI_ACCESS_PROFILE_REQ_V01 0x002A
#define QL_MANAGER_MSGR_SET_WIFI_ACCESS_PROFILE_RESP_V01 0x002A
#define QL_MANAGER_MSGR_GET_WIFI_ACCESS_PROFILE_REQ_V01 0x002B
#define QL_MANAGER_MSGR_GET_WIFI_ACCESS_PROFILE_RESP_V01 0x002B
#define QL_MANAGER_MSGR_SET_DATA_CALL_UP_REQ_V01 0x002C
#define QL_MANAGER_MSGR_SET_DATA_CALL_UP_RESP_V01 0x002C
#define QL_MANAGER_MSGR_SET_DATA_CALL_DOWN_REQ_V01 0x002D
#define QL_MANAGER_MSGR_SET_DATA_CALL_DOWN_RESP_V01 0x002D
#define QL_MANAGER_MSGR_GET_DATA_CALL_INFO_REQ_V01 0x002E
#define QL_MANAGER_MSGR_GET_DATA_CALL_INFO_RESP_V01 0x002E
#define QL_MANAGER_MSGR_DATA_CALL_STATUS_EVENT_IND_V01 0x002F
#define QL_MANAGER_MSGR_SET_DATA_CALL_APN_REQ_V01 0x0030
#define QL_MANAGER_MSGR_SET_DATA_CALL_APN_RESP_V01 0x0030
#define QL_MANAGER_MSGR_GET_DATA_CALL_APN_REQ_V01 0x0031
#define QL_MANAGER_MSGR_GET_DATA_CALL_APN_RESP_V01 0x0031
#define QL_MANAGER_MSGR_GET_DATA_CALL_APN_LIST_REQ_V01 0x0032
#define QL_MANAGER_MSGR_GET_DATA_CALL_APN_LIST_RESP_V01 0x0032
#define QL_MANAGER_MSGR_DEL_DATA_CALL_APN_REQ_V01 0x0033
#define QL_MANAGER_MSGR_DLE_DATA_CALL_APN_RESP_V01 0x0033
#define QL_MANAGER_MSGR_ADD_DATA_CALL_APN_REQ_V01 0x0034
#define QL_MANAGER_MSGR_ADD_DATA_CALL_APN_RESP_V01 0x0034
#define QL_MANAGER_MSGR_SET_DATA_CALL_DEFAULT_PROFILE_REQ_V01 0x0035
#define QL_MANAGER_MSGR_SET_DATA_CALL_DEFAULT_PROFILE_RESP_V01 0x0035
#define QL_MANAGER_MSGR_GET_DATA_CALL_DEFAULT_PROFILE_REQ_V01 0x0036
#define QL_MANAGER_MSGR_GET_DATA_CALL_DEFAULT_PROFILE_RESP_V01 0x0036
#define QL_MANAGER_MSGR_ADD_NETWORK_DMZ_REQ_V01 0x0037
#define QL_MANAGER_MSGR_ADD_NETWORK_DMZ_RESP_V01 0x0037
#define QL_MANAGER_MSGR_DEL_NETWORK_DMZ_REQ_V01 0x0038
#define QL_MANAGER_MSGR_DEL_NETWORK_DMZ_RESP_V01 0x0038
#define QL_MANAGER_MSGR_GET_NETWORK_DMZ_REQ_V01 0x0039
#define QL_MANAGER_MSGR_GET_NETWORK_DMZ_RESP_V01 0x0039
#define QL_MANAGER_MSGR_SET_NETWORK_SGMII_ENABLE_REQ_V01 0x003A
#define QL_MANAGER_MSGR_SET_NETWORK_SGMII_ENABLE_RESP_V01 0x003A
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_ENABLE_REQ_V01 0x003B
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_ENABLE_RESP_V01 0x003B
#define QL_MANAGER_MSGR_SET_NETWORK_SGMII_CONFIG_REQ_V01 0x003C
#define QL_MANAGER_MSGR_SET_NETWORK_SGMII_CONFIG_RESP_V01 0x003C
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_CONFIG_REQ_V01 0x003D
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_CONFIG_RESP_V01 0x003D
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_INFO_REQ_V01 0x003E
#define QL_MANAGER_MSGR_GET_NETWORK_SGMII_INFO_RESP_V01 0x003E
#define QL_MANAGER_MSGR_SET_NETWORK_LAN_CONFIG_REQ_V01 0x003F
#define QL_MANAGER_MSGR_SET_NETWORK_LAN_CONFIG_RESP_V01 0x003F
#define QL_MANAGER_MSGR_GET_NETWORK_LAN_CONFIG_REQ_V01 0x0040
#define QL_MANAGER_MSGR_GET_NETWORK_LAN_CONFIG_RESP_V01 0x0040
#define QL_MANAGER_MSGR_ADD_NETWORK_SNAT_REQ_V01 0x0041
#define QL_MANAGER_MSGR_ADD_NETWORK_SNAT_RESP_V01 0x0041
#define QL_MANAGER_MSGR_DEL_NETWORK_SNAT_REQ_V01 0x0042
#define QL_MANAGER_MSGR_DEL_NETWORK_SNAT_RESP_V01 0x0042
#define QL_MANAGER_MSGR_GET_NETWORK_SNAT_REQ_V01 0x0043
#define QL_MANAGER_MSGR_GET_NETWORK_SNAT_RESP_V01 0x0043
#define QL_MANAGER_MSGR_SET_NETWORK_ETH_MODE_REQ_V01 0x0044
#define QL_MANAGER_MSGR_SET_NETWORK_ETH_MODE_RESP_V01 0x0044
#define QL_MANAGER_MSGR_GET_NETWORK_ETH_MODE_REQ_V01 0x0045
#define QL_MANAGER_MSGR_GET_NETWORK_ETH_MODE_RESP_V01 0x0045
#define QL_MANAGER_MSGR_SET_IPPT_CONFIG_REQ_V01 0x0046
#define QL_MANAGER_MSGR_SET_IPPT_CONFIG_RESP_V01 0x0046
#define QL_MANAGER_MSGR_GET_IPPT_CONFIG_REQ_V01 0x0047
#define QL_MANAGER_MSGR_GET_IPPT_CONFIG_RESP_V01 0x0047
#define QL_MANAGER_MSGR_SET_USB_CONFIG_WRITE_REQ_V01 0x0048
#define QL_MANAGER_MSGR_SET_USB_CONFIG_WRITE_RESP_V01 0x0048
#define QL_MANAGER_MSGR_SET_USB_ACTION_TYPE_REQ_V01 0x0049
#define QL_MANAGER_MSGR_SET_USB_ACTION_TYPE_RESP_V01 0x0049
#define QL_MANAGER_MSGR_SET_USB_BOOTUP_REQ_V01 0x004A
#define QL_MANAGER_MSGR_SET_USB_BOOTUP_RESP_V01 0x004A
#define QL_MANAGER_MSGR_SET_USB_ID_REQ_V01 0x004B
#define QL_MANAGER_MSGR_SET_USB_ID_RESP_V01 0x004B
#define QL_MANAGER_MSGR_SET_USB_PRODUCT_INFO_REQ_V01 0x004C
#define QL_MANAGER_MSGR_SET_USB_PRODUCT_INFO_RESP_V01 0x004C
#define QL_MANAGER_MSGR_SET_USB_MANUFAC_INFO_REQ_V01 0x004D
#define QL_MANAGER_MSGR_SET_USB_MANUFAC_INFO_RESP_V01 0x004D
#define QL_MANAGER_MSGR_SET_USB_NET_REQ_V01 0x004E
#define QL_MANAGER_MSGR_SET_USB_NET_RESP_V01 0x004E
#define QL_MANAGER_MSGR_SET_USB_FUNC_REQ_V01 0x004F
#define QL_MANAGER_MSGR_SET_USB_FUNC_RESP_V01 0x004F
#define QL_MANAGER_MSGR_GET_USB_CONFIG_REQ_V01 0x0050
#define QL_MANAGER_MSGR_GET_USB_CONFIG_RESP_V01 0x0050
#define QL_MANAGER_MSGR_SET_USB_INTERFACE_REQ_V01 0x0051
#define QL_MANAGER_MSGR_SET_USB_INTERFACE_RESP_V01 0x0051
#define QL_MANAGER_MSGR_GET_USB_INTERFACE_REQ_V01 0x0052
#define QL_MANAGER_MSGR_GET_USB_INTERFACE_RESP_V01 0x0052
#define QL_MANAGER_MSGR_SET_BT_ADDR_REQ_V01 0x0053
#define QL_MANAGER_MSGR_SET_BT_ADDR_RESP_V01 0x0053
#define QL_MANAGER_MSGR_GET_BT_ADDR_REQ_V01 0x0054
#define QL_MANAGER_MSGR_GET_BT_ADDR_RESP_V01 0x0054
/**
    @}
  */
