...
typedef enum {
	...
	QL_MGMT_CLIENT_COMMAND_NETWORK_IPPT_CONFIG_SET    = 0x000c,
	QL_MGMT_CLIENT_COMMAND_NETWORK_IPPT_CONFIG_GET    = 0x000d,
...
typedef struct {
	union {
		...
		struct network_ippt_config ippt_config;
	};
