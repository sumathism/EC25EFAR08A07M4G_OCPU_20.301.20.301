...
/**  the maximum station scan result numbers. */
#define WIFI_MAX_STA_SCAN_RESULT_CNT_V01 64
/**
    @}
  */
...
/** @addtogroup ql_manager_access_msgr_wifi_qmi_enums
  ...
  */
typedef enum {
  WIFI_SSID_FORMAT_TYPE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WIFI_SSID_FORMAT_TYPE_NONE_V01 = 0, 
  WIFI_SSID_FORMAT_TYPE_DOUBLE_QUOTED_V01 = 1, 
  WIFI_SSID_FORMAT_TYPE_HEXDUMP_V01 = 2, 
  WIFI_SSID_FORMAT_TYPE_PRINTF_ESCAPED_V01 = 3, 
  WIFI_SSID_FORMAT_TYPE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wifi_ssid_format_type_e_v01;
/**
    @}
  */
...
/** @addtogroup ql_manager_access_msgr_wifi_qmi_enums
  ...
  */
typedef enum {
  WIFI_WORK_ACCESS_PROFILE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WIFI_AP_PROFILE_FULL_ACCESS_V01 = 0, 
  WIFI_AP_PROFILE_INTERNET_ONLY_V01 = 1, 
  WIFI_WORK_ACCESS_PROFILE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wifi_work_access_profile_e_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /*  Adds the wps algorithm flag bit by Harry.gong */
  uint8_t flags;
}__wifi_scan_result_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t idx;
}ql_manager_msgr_set_wifi_sta_scan_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  result_v01 res;
}ql_manager_msgr_set_wifi_sta_scan_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t idx;
}ql_manager_msgr_set_wifi_sta_scan_done_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t idx;
}ql_manager_msgr_get_wifi_sta_scan_result_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  __wifi_scan_result_v01 scan_result[WIFI_MAX_STA_SCAN_RESULT_CNT_V01];
}ql_manager_msgr_get_wifi_sta_scan_result_resp_msg_v01;  /* Message */
/**
    @}
  */
...
}ql_manager_msgr_set_wifi_access_profile_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  result_v01 res;
}ql_manager_msgr_set_wifi_access_profile_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}ql_manager_msgr_get_wifi_access_profile_req_msg_v01;
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t access_profile;
}ql_manager_msgr_get_wifi_access_profile_resp_msg_v01;  /* Message */
/**
    @}
  */
