...
/*========================================================================
  FUNCTION: usb_command_handle
=========================================================================*/
/*! @brief 
     Gets or Sets Usb configuration.
...
*/
/*=======================================================================*/
extern int usb_command_handle(ql_mgmt_client_s *handle, s32 command_flag,
			      u32 command, ql_mgmt_client_usb_s *usb);
#endif /* end of FEATURE_QL_USB */

#ifdef FEATURE_QL_BT
/*========================================================================
  FUNCTION: bt_command_handle
=========================================================================*/
/*! @brief 
     Gets or Sets BT configuration.

    @param[in] handle          Handle used by the infrastructure to
                               identify different clients.
    @param[in] command_flag    The gets or sets flag.
    @param[in] command         The commands of manager client.
    @param[in] BT             The BT configuration.

    @return
       On success, 0 is return. On error, -1 is return.
*/
/*=======================================================================*/
extern int bt_command_handle(ql_mgmt_client_s *handle, s32 command_flag,
			      u32 command, ql_mgmt_client_bt_s *bt);
