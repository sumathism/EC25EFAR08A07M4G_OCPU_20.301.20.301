...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Fri Sep  8 2023 (Spin 0)
...
/**  Maximum length of an etws cb SMS. */
#define MCM_SMS_MAX_ETWS_MSG_LENGTH_V01 1252
...
/** @addtogroup mcm_sms_qmi_enums
  ...
  */
typedef enum {
  MCM_SMS_ETWS_NOTIFICATION_TYPE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_SMS_ETWS_NOTIFICATION_TYPE_INVALID_V01 = -1, 
  MCM_SMS_ETWS_NOTIFICATION_TYPE_PRIMARY_V01 = 0, /**<  Primary */
  MCM_SMS_ETWS_NOTIFICATION_TYPE_SECONDARY_GSM_V01 = 1, /**<  Secondary GSM */
  MCM_SMS_ETWS_NOTIFICATION_TYPE_SECONDARY_UMTS_V01 = 2, /**<  Secondary UMTS */
  MCM_SMS_ETWS_NOTIFICATION_TYPE_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_sms_etws_notification_type_t_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<     network code.*/
}mcm_etws_plmn_info_type_t_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup mcm_sms_qmi_messages
    @{
  */
/** Request Message; Cell broadcast ETWS message indication. */
typedef struct {
  ...
  /* Mandatory */
  mcm_sms_etws_notification_type_t_v01 notification_type;
  /**<   Message format. */

  /* Mandatory */
  mcm_etws_plmn_info_type_t_v01 etws_plmn_info;
  /**<   Message format. */

  /* Mandatory */
  uint32_t message_content_len;  /**< Must be set to # of elements in message_content */
  char message_content[MCM_SMS_MAX_ETWS_MSG_LENGTH_V01];
  /**<   Message content. */
}mcm_sms_cb_etws_ind_msg_v01;  /* Message */
/**
    @}
  */
...
#define MCM_SMS_CB_ETWS_IND_V01 0x070B
