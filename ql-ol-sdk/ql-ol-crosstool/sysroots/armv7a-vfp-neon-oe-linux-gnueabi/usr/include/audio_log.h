...
{ \
    ...
    { \
        case AUDIO_DEBUG: \
            __android_log_print(ANDROID_LOG_DEBUG, "", "%s[%d]:"format, __FILE__, __LINE__, ##__VA_ARGS__); \
            break; \
        case AUDIO_INFO: \
            __android_log_print(ANDROID_LOG_INFO, "", "%s[%d]:"format, __FILE__, __LINE__, ##__VA_ARGS__); \
            break; \
        case AUDIO_WARN: \
            __android_log_print(ANDROID_LOG_WARN, "", "%s[%d]:"format, __FILE__, __LINE__, ##__VA_ARGS__); \
            break; \
        case AUDIO_ERROR: \
            __android_log_print(ANDROID_LOG_ERROR, "", "%s[%d]:"format, __FILE__, __LINE__, ##__VA_ARGS__); \
            break; \
        case AUDIO_FATAL: \
            __android_log_print(ANDROID_LOG_FATAL, "", "%s[%d]:"format, __FILE__, __LINE__, ##__VA_ARGS__); \
            break; \
        default: \
            break; \
    } \
