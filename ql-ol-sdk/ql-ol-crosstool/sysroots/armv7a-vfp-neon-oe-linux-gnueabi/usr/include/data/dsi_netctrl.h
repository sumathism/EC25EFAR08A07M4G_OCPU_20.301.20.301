...
/* DFS add filters request */
typedef dfs_add_mo_exceptional_filters_req_msg_v01 dsi_dfs_add_mo_exceptional_filters_req_t;
/* DFS add filters response */
typedef dfs_add_mo_exceptional_filters_resp_msg_v01 dsi_dfs_add_mo_exceptional_filters_resp_t;
/* DFS remove filters request */
typedef dfs_remove_mo_exceptional_filters_req_msg_v01 dsi_dfs_remove_mo_exceptional_filters_req_t;
/* DFS remove filters response */
typedef dfs_remove_mo_exceptional_filters_resp_msg_v01 dsi_dfs_remove_mo_exceptional_filters_resp_t;
...
#define DSI_EFLOWCTRL     105   /**< DSI received Flow Suspended Error for NON IP Call. */
...
typedef enum dsi_call_info_enum_e
{
  ...
  DSI_CALL_INFO_MO_EXCEPTION,     /**< Set MO Exception for the call. */
  DSI_CALL_INFO_MAX
...
typedef enum
{
  ...
  DSI_EVT_NON_IP_DL_DATA,             /**< NIPD DL Data Indication */
...
/** For Non-IP Downlink Data */
  struct nipd_dl_data_s
  {
    uint8_t   *data;       /**< NIPD data buf ptr. */
    uint32_t  data_len;    /**< NIPD data length. */
  } nipd_dl_data;
...
/*!
    ...
    @param
      hndl - DSI data service handle
      data - payload to be sent.
      data_len - payload length.
      mo_exception - TRUE if MO Exception data is being sent
...
/*===========================================================================
FUNCTION:  dsi_dfs_add_mo_exception_ipdata_filters
===========================================================================*/
/*!
    @brief
    ...
    @param
      hndl - Handle received from dsi_get_data_srvc_hndl()
      filter_req - Filter rules information to be added
      filter_rsp - Filter rules handles and error information
...
extern int dsi_dfs_add_mo_exception_ipdata_filters
(
  dsi_hndl_t     hndl,
  dsi_dfs_add_mo_exceptional_filters_req_t  *filter_req,
  dsi_dfs_add_mo_exceptional_filters_resp_t *filter_rsp
);

/*===========================================================================
FUNCTION:  dsi_dfs_remove_mo_exception_ipdata_filters
===========================================================================*/
/*!
    @brief
    Removes filters for MO Exception IP data call.

    @param
      hndl - Handle received from dsi_get_data_srvc_hndl()
      filter_req - Filter rules information to be removed
...
extern int dsi_dfs_remove_mo_exception_ipdata_filters
(
  dsi_hndl_t     hndl,
  dsi_dfs_remove_mo_exceptional_filters_req_t  *filter_req
);
