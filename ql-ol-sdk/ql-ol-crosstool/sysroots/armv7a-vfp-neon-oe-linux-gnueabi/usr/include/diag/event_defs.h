...
typedef enum
{
  ...
  EVENT_CM_DS_SYSTEM_MODE = 0x71c,       /*2 byte payload*/ /*1820*/
  ...
  EVENT_PROSE_TIMER_STATUS                             = 0xB15,
  EVENT_PROSE_DISC_SERVICE_STATUS                      = 0xB16,
  EVENT_PROSE_DISC_SESSION_START                       = 0xB17,
  EVENT_PROSE_DISC_SESSION_STOP                        = 0xB18,
  EVENT_PROSE_DISC_SESSION_STATUS                      = 0xB19,
  EVENT_WLAN_SSR                                       = 0xB1A,
  EVENT_WCDMA_ASDIV_PORT_SWITCH                        = 0xB1B,
  EVENT_PM_FREQ_LIST                                   = 0xB1C,
  EVENT_PM_CALL_MODE                                   = 0xB1D,
  EVENT_PM_SVC_MODE                                    = 0xB1E,
  EVENT_PM_SCAN_OPT                                    = 0xB1F,
  EVENT_PM_RAT_ORDER                                   = 0xB20,
  EVENT_PM_RF_BANDS                                    = 0xB21,
  EVENT_PM_VOICE_DOMAIN_PREF                           = 0xB22,
  EVENT_PM_FULL_RAT_EVAL                               = 0xB23,
  EVENT_PM_ENTER_FULL_RAT                              = 0xB24,
  EVENT_TDSCDMA_ASDIV_SWITCH_REQUEST                   = 0xB25,
  EVENT_TDSCDMA_ASDIV_SWITCH_COMPLETE_FW               = 0xB26,
  EVENT_TDSCDMA_ASDIV_SWITCH_REQUEST_DENIED_BY_TRM     = 0xB27,
  EVENT_LTE_RRC_ALTCQI_TABLE_IN_OTA                    = 0xB28,
  EVENT_IWLAN_S2B_FAILURE                              = 0xB29,
  EVENT_GSM_PAGE_MISSED_OTHER_SUB_IN_VOICE_CALL        = 0xB2A,
