...
/**
 * @brief Get playback check amr header,whether to end playback after detecting
 * too much bad audio farme.
 * @param head
 *      NULL 
 * @return 
 *      get end playback flag  
 */
char Ql_get_amrheader_mark_check(void);

/**
 * @brief Set playback check amr header,whether to end playback after detecting
 * too much bad audio farme.
 * @param head
 *      mark_flag
 * @return 
 *      NULL    
 */
void Ql_set_amrheader_mark_check(char mark_flag);
#endif
