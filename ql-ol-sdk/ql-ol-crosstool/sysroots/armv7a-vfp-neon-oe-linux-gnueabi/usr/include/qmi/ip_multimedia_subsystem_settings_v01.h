...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.BO.2.5.c6.5/Main/modem_proc/qmimsgs/imss/api/ip_multimedia_subsystem_settings_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7
   It was generated on: Tue Feb  9 2016 (Spin 0)
...
#define IMSS_V01_IDL_MINOR_VERS 0x2B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSS_V01_MAX_MESSAGE_ID 0x0066
/**
    @}
  */
...
typedef enum {
  ...
  IMS_SETTINGS_IP_TYPE_IPV4V6_V01 = 0x04,
  IMS_SETTINGS_IP_TYPE_IPV6V4_V01 = 0x05,
  IMS_SETTINGS_IP_TYPE_IPV4V6PIP_V01 = 0x06,
  IMS_SETTINGS_IP_TYPE_IPV6V4PIP_V01 = 0x07,
...
typedef struct {
 ...
 request, a value of IMS_SETTINGS_IP_TYPE_ UNKNOWN is used. Values:\n
      ...
      - IMS_SETTINGS_IP_TYPE_IPV4V6 (0x04) --
      - IMS_SETTINGS_IP_TYPE_IPV6V4 (0x05) --
      - IMS_SETTINGS_IP_TYPE_IPV4V6PIP (0x06) --
      - IMS_SETTINGS_IP_TYPE_IPV6V4PIP (0x07) --
 */

  /* Optional */
  /*  Ut Interface Access Point Name for Wifi */
  ...
  /* Optional */
  /*  Ut Interface IP Address Type for Wifi */
...
typedef struct {
  ...
  /**<   Codec information associated to profile id.  */
