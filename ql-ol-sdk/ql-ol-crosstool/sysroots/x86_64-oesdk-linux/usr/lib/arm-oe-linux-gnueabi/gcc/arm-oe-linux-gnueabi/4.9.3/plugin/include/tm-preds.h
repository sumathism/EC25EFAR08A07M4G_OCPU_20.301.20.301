/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/P4code/depot3/Qualcomm/MDM9x07/MCU_R08/apps_proc/poky/build/tmp-glibc/work-shared/gcc-4.9.3-r0/gcc-4.9.3/gcc/config/arm/arm.md'.  */
