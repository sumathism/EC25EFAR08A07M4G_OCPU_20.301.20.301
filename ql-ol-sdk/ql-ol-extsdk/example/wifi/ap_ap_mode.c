...
#include "ql_wifi.h"
 ...
 int main(int argc, char **argv)
 {
	...
	ql_wifi_ap_isolate_set(QL_WIFI_AP_INDEX_AP0, DISABLE);
	...
	ql_wifi_ap_mode_set(QL_WIFI_AP_INDEX_AP1, QL_WIFI_MODE_80211AC);
	ql_wifi_ap_bandwidth_set(QL_WIFI_AP_INDEX_AP1, QL_WIFI_BANDWIDTH_HT20);
	ql_wifi_ap_channel_set(QL_WIFI_AP_INDEX_AP1, 36);
	ql_wifi_ap_isolate_set(QL_WIFI_AP_INDEX_AP1, DISABLE);
	...
	ql_wifi_access_profile_set(WIFI_AP_PROFILE_FULL_ACCESS);
