...
int main(int argc, char *argv[])
{
	...
	if(argc <= 1)
	{
	    QL_TTS_LOG("parameter is invalid \n");
		return -1;
	}
	else if(argc == 3)
	{
    ...
    else if (strcmp(argv[1], "gv") == 0 && argc == 2) {
    ...
    else if (strcmp(argv[1], "gs") == 0 && argc == 2) {
