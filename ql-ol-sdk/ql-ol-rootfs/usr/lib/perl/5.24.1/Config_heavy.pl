...
ccflags=' -O2 -fexpensive-optimizations -frename-registers -fomit-frame-pointer -include quectel-features-config.h -fstack-protector-strong -pie -fpie -Wa,--noexecstack -DDEBIAN -D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
ccflags_uselargefiles=' -O2 -fexpensive-optimizations -frename-registers -fomit-frame-pointer -include quectel-features-config.h -fstack-protector-strong -pie -fpie -Wa,--noexecstack -DDEBIAN -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
...
ccflags_nolargefiles=' -O2 -fexpensive-optimizations -frename-registers -fomit-frame-pointer -include quectel-features-config.h -fstack-protector-strong -pie -fpie -Wa,--noexecstack -DDEBIAN -D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
