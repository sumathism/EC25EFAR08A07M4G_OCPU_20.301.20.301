...
//asa.wang-20180207: add qualcomm CR 2050812 Power [LE925A4-KR] modem crash at the 85'c high temperature
#define QUECTEL_INC_CR2050812
#if defined(QUECTEL_INC_CR2050812)
#include <linux/msm-bus.h>
#endif //#if defined(QUECTEL_INC_CR2050812)
