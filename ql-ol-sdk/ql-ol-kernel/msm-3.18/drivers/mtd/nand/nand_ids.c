...
//add by len 20180413
//for 2+2 flash configration (JSFBBx3YH3BBG)
#if 1
    {"JSFBB3YH3BBG 2G 1.8V 4-bit",
		{ .id = {0xad, 0xaa, 0x90, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_256, SZ_128K, 0, 4, 128, NAND_ECC_INFO(4, SZ_512)},
#endif

//for 2+2 flash configration (NM1282KSLAXAL)
#if 1
    {"NM1282KSLAXAL 2G 1.8V 4-bit",
		{ .id = {0x98, 0xaa, 0x90, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_256, SZ_128K, 0, 4, 128, NAND_ECC_INFO(4, SZ_512)},
#endif
//add end

#if 1   //quectel add FM6BD2G2GXA
    {"FM6BD2G2GXA 2G 1.8V 8-bit",
...
#endif
#if 1   //quectel add JSFCB3YH3BX
    {"JSFCB3YH3B1 4G 1.8V 4-bit",
		{ .id = {0xAD, 0xAC, 0x80, 0x16, 0x00, 0x00, 0x00, 0x00} },
		SZ_4K, SZ_512, SZ_256K, 0, 4, 256, NAND_ECC_INFO(4, SZ_512)},
    {"JSFCB3YH3B2 4G 1.8V 4-bit",
		{ .id = {0x01, 0xAC, 0x80, 0x16, 0x00, 0x00, 0x00, 0x00} },
		SZ_4K, SZ_512, SZ_256K, 0, 4, 256, NAND_ECC_INFO(4, SZ_512)},		
#endif
#if 1   //quectel add FM6BD4G2GXB
    {"FM6BD4G2GXB 4G 1.8V 8-bit",
...
//add by Shuaifeng,for 1+1 flash
#if 1
	{"FM6BD1G12MB 1.8V 8-bit",
		{ .id = {0xC8, 0x61, 0x80, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 64, NAND_ECC_INFO(4, SZ_512)},

	{"SCP30N1G1GSL 1.8V 8-bit",
		{ .id = {0x01, 0xA1, 0x80, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 64, NAND_ECC_INFO(4, SZ_512)},

	{"JSFAAA3YHABBG 1.8V 8-bit",
		{ .id = {0xAD, 0xA1, 0x80, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 64, NAND_ECC_INFO(4, SZ_512)},
	{"PN611G8C2TA 1.8V 8-bit",
		{ .id = {0x98, 0xA1, 0x80, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 128, NAND_ECC_INFO(8, SZ_512)},
#endif
#if 1	// quectel add W71NW10HM3FW　1G nand flash
	{"W71NW10HM3FW 1.8V 8-bit",
		{ .id = {0xEF, 0xA1, 0x00, 0x95, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 64, NAND_ECC_INFO(1, SZ_512)},
#endif
#if 1	// quectel add NM1181KSLAXAJ 1G nand flash
	{"NM1181KSLAXAJ 1.8V 8-bit",
		{ .id = {0x98, 0xA1, 0x90, 0x15, 0x00, 0x00, 0x00, 0x00} },
		SZ_2K, SZ_128, SZ_128K, 0, 4, 128, NAND_ECC_INFO(8, SZ_512)},
#endif
