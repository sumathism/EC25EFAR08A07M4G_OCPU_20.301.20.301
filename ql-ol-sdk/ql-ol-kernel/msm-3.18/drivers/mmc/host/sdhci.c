...
static void sdhci_request(struct mmc_host *mmc, struct mmc_request *mrq)
{
	 ...
	 */
	/*present = mmc_gpio_get_cd(host->mmc);*/ /*Quinn comment for SD Card Detect*/
	present = sdhci_get_cd(host->mmc); /*Quinn add for SD Card Detect*/
	if (present < 0) {
