 ...
 */
 ...
 struct QuecUsbInterfaceId  QuecUsbDefine_RMNET[QUEC_USB_INTERFACE_MAX+1]={
	{QUEC_USB_INTERFACE_0,		"diag"},
	{QUEC_USB_INTERFACE_1,		"nmea"},
	{QUEC_USB_INTERFACE_2,		"smd_at"},
	{QUEC_USB_INTERFACE_3,		"smd_modem"},
	{QUEC_USB_INTERFACE_4,		"rmnet0"},
	{QUEC_USB_INTERFACE_5,		"Function FS Gadget"},
	{QUEC_USB_INTERFACE_6,		"g_audio_ctrl"},
	{QUEC_USB_INTERFACE_7,		"g_audio_microphone"},
	{QUEC_USB_INTERFACE_8,		"g_audio_speaker"},
	{QUEC_USB_INTERFACE_9,		""/*reserve*/},
	{QUEC_USB_INTERFACE_10,		""/*reserve*/},
	{QUEC_USB_INTERFACE_11,		""/*reserve*/},
	{QUEC_USB_INTERFACE_12,		""/*reserve*/},
	{QUEC_USB_INTERFACE_13,		""/*reserve*/},
	{QUEC_USB_INTERFACE_14,		""/*reserve*/},
	{QUEC_USB_INTERFACE_15,		""/*reserve*/}
};

struct QuecUsbInterfaceId  QuecUsbDefine_ECM[QUEC_USB_INTERFACE_MAX+1]={
	{QUEC_USB_INTERFACE_0,		"diag"},
	{QUEC_USB_INTERFACE_1,		"nmea"},
	{QUEC_USB_INTERFACE_2,		"smd_at"},
	{QUEC_USB_INTERFACE_3,		"smd_modem"},
	{QUEC_USB_INTERFACE_4,		"cdc_ethernet_ctrl"},
	{QUEC_USB_INTERFACE_5,		"cdc_ethernet_data"},
	{QUEC_USB_INTERFACE_6,		"Function FS Gadget"},
	{QUEC_USB_INTERFACE_7,		"g_audio_ctrl"},
	{QUEC_USB_INTERFACE_8,		"g_audio_microphone"},
	{QUEC_USB_INTERFACE_9,		"g_audio_speaker"},
	{QUEC_USB_INTERFACE_10,		""/*reserve*/},
	{QUEC_USB_INTERFACE_11,		""/*reserve*/},
	{QUEC_USB_INTERFACE_12,		""/*reserve*/},
	{QUEC_USB_INTERFACE_13,		""/*reserve*/},
...
struct QuecUsbInterfaceId  QuecUsbDefine_MBIM[QUEC_USB_INTERFACE_MAX+1]={
	{QUEC_USB_INTERFACE_0,		"diag"},
	{QUEC_USB_INTERFACE_1,		"nmea"},
	{QUEC_USB_INTERFACE_2,		"smd_at"},
	{QUEC_USB_INTERFACE_3,		"smd_modem"},
	{QUEC_USB_INTERFACE_4,		"usb_mbim_ctrl"},
	{QUEC_USB_INTERFACE_5,		"usb_mbim_data"},
	{QUEC_USB_INTERFACE_6,		"Function FS Gadget"},
	{QUEC_USB_INTERFACE_7,		"g_audio_ctrl"},
	{QUEC_USB_INTERFACE_8,		"g_audio_microphone"},
	{QUEC_USB_INTERFACE_9,		"g_audio_speaker"},
...
struct QuecUsbInterfaceId  QuecUsbDefine_RNDIS[QUEC_USB_INTERFACE_MAX+1]={
	{QUEC_USB_INTERFACE_0,		"rndis_ctrl"},
	{QUEC_USB_INTERFACE_1,		"rndis_data"},
	{QUEC_USB_INTERFACE_2,		"diag"},
	{QUEC_USB_INTERFACE_3,		"nmea"},
	{QUEC_USB_INTERFACE_4,		"smd_at"},
	{QUEC_USB_INTERFACE_5,		"smd_modem"},
	{QUEC_USB_INTERFACE_6,		"Function FS Gadget"},
	{QUEC_USB_INTERFACE_7,		"g_audio_ctrl"},
	{QUEC_USB_INTERFACE_8,		"g_audio_microphone"},
	{QUEC_USB_INTERFACE_9,		"g_audio_speaker"},
...
struct QuecUsbInterfaceId *seq_select_p = QuecUsbDefine_RMNET;
static int current_usbnet_mode_g = QUEC_USBNET_MODE_RMNET;
int usb_interface_id(struct usb_configuration *config, struct usb_function *function)
{
	...
	unsigned id = 0;
	u8  i = 0,j = 0;
	u8	interface_num_sequence = QUEC_USBNET_MODE_SECQUENCE_RMNET;

	if (!function->name) {
		pr_err("[usb][quectel] Function name is NULL.\r\n");
		return -EINVAL;
	}

	if(usb_cfg.usbnet == QUEC_USBNET_MODE_SECQUENCE_RMNET)
	{
		seq_select_p = QuecUsbDefine_RMNET;
		current_usbnet_mode_g = QUEC_USBNET_MODE_RMNET;
		pr_info("[usb][%s] interface QuecUsbDefine_RMNET.\n",__func__);

	}else if(usb_cfg.usbnet == QUEC_USBNET_MODE_SECQUENCE_ECM)
	{
		seq_select_p = QuecUsbDefine_ECM;
		current_usbnet_mode_g = QUEC_USBNET_MODE_ECM;
		pr_info("[usb][%s] interface QuecUsbDefine_ECM.\n",__func__);

	}else if(usb_cfg.usbnet == QUEC_USBNET_MODE_SECQUENCE_MBIM)
	{	
		seq_select_p = QuecUsbDefine_MBIM;
		current_usbnet_mode_g = QUEC_USBNET_MODE_MBIM;
		pr_info("[usb][%s] interface QuecUsbDefine_MBIM.\n",__func__);

	}else if(usb_cfg.usbnet == QUEC_USBNET_MODE_SECQUENCE_RNDIS)
	{
		seq_select_p = QuecUsbDefine_RNDIS;
		current_usbnet_mode_g = QUEC_USBNET_MODE_RNDIS;
		pr_info("[usb][%s] interface QuecUsbDefine_RNDIS.\n",__func__);	
	}	
	for (i=0; i< QUEC_USB_INTERFACE_MAX; i++) {
		if (strcmp(function->name, seq_select_p[i].FunctionName) == 0) {
			
			if(strcmp(function->name, "rndis_data") == 0)
				strcpy(function->name,"rndis");
			else if(strcmp(function->name, "rndis_ctrl") == 0)
				strcpy(function->name,"rndis");	

			if(config->interface[i] != NULL)
				continue;
			config->interface[i] = function;
			if (function->intf_id < 0) {
				function->intf_id = seq_select_p[i].InterfaceId;
				pr_info("[usb][%s] interface name:%s, id:%d.\n",__func__,function->name,function->intf_id);		
			}
			id = seq_select_p[i].InterfaceId;
			break;	
		}
	}
	if (i == QUEC_USB_INTERFACE_MAX)  {
		if(QUEC_USBNET_MODE_RMNET == current_usbnet_mode_g)
			j = QUEC_USB_INTERFACE_9;
		else 
			j = QUEC_USB_INTERFACE_10;
		
		for (; j<QUEC_USB_INTERFACE_MAX; j++) {
			if(config->interface[j] == NULL)
				break;
		}

		if (j == QUEC_USB_INTERFACE_MAX) {
			pr_err("[usb][quectel]--alocation-usb_interface_id--fail\r\n");
			return -ENODEV;
		}

		config->interface[j] = function;
		if (function->intf_id < 0) {
			function->intf_id = j;
			pr_info("[usb][%s] Add a new interface name:%s, id:%d.\n",__func__,function->name,function->intf_id);
		}
		id=j;
	}
