...
struct QuecUsbInterfaceId {
		u8		InterfaceId;
		char	FunctionName[20];
};
enum QuecUsbInterfaceIdType {
	QUEC_USB_INTERFACE_0 = 0,
	QUEC_USB_INTERFACE_1,
	QUEC_USB_INTERFACE_2,
	QUEC_USB_INTERFACE_3,
	QUEC_USB_INTERFACE_4,
	QUEC_USB_INTERFACE_5,
	QUEC_USB_INTERFACE_6,
	QUEC_USB_INTERFACE_7,
	QUEC_USB_INTERFACE_8,
	QUEC_USB_INTERFACE_9,
	QUEC_USB_INTERFACE_10,
	QUEC_USB_INTERFACE_11,
	QUEC_USB_INTERFACE_12,
	QUEC_USB_INTERFACE_13,
	QUEC_USB_INTERFACE_14,
	QUEC_USB_INTERFACE_15,	
	QUEC_USB_INTERFACE_MAX
};

enum USBnetModeType {
	QUEC_USBNET_MODE_RMNET,
	QUEC_USBNET_MODE_ECM,
	QUEC_USBNET_MODE_MBIM,
	QUEC_USBNET_MODE_RNDIS
};

enum USBnetModeSecquenceNum {
	QUEC_USBNET_MODE_SECQUENCE_RMNET,
	QUEC_USBNET_MODE_SECQUENCE_ECM,
	QUEC_USBNET_MODE_SECQUENCE_MBIM,
	QUEC_USBNET_MODE_SECQUENCE_RNDIS
};

struct QuecUsbMarkOpenState {
	u8  NmeaMarkOpenState;/*nmea port*/
	u8  SMDATMarkOpenState;/*AT port*/
	u8  SMDModemMarkOpenState;/*modem port*/
	u8  InitMark;
};

extern struct QuecUsbMarkOpenState QuecSerialPortState;
