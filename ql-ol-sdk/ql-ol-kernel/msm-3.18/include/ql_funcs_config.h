...
//#if QUECTEL_OMA_DM
//#define QUECTEL_ODM_UPDATE_AUTO 1
...
//Laurence.yin-2018/07/17-QCM9XOL00004C015-P01, <[DM] : add dm surport macro.>
#define QL_INIT_WMS_CONFIGURATION_UIM_SURPORT

#if defined (__QUECTEL_PROJECT_EG91EX_GB__)
#define QL_LOC_GET_PREDICTED_SUPPORT
#endif
